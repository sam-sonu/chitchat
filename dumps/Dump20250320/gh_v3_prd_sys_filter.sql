...
--
-- Dumping data for table `sys_filter`
--

LOCK TABLES `sys_filter` WRITE;
/*!40000 ALTER TABLE `sys_filter` DISABLE KEYS */;
/*!40000 ALTER TABLE `sys_filter` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-20 17:01:03
