...
--
-- Dumping data for table `member_fav_growthplan`
--

LOCK TABLES `member_fav_growthplan` WRITE;
/*!40000 ALTER TABLE `member_fav_growthplan` DISABLE KEYS */;
/*!40000 ALTER TABLE `member_fav_growthplan` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-03-20 17:01:08
